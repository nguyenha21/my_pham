...
<body>
  <DOCTYPE html>
    ...
    <head>
       ...
       <meta charset="utf-8">
       <link href="<c:url value='/template/web/public/css/site.min.css'/>" rel="stylesheet" type="text/css">
       <link href="<c:url value='/template/web/public/css/style.css'/>" rel="stylesheet" type="text/css">
       ...
       <link href="<c:url value='/template/web/public/owlcarousel/assets/owl.carousel.min.css'/>" rel="stylesheet" type="text/css">
       <link href="<c:url value='/template/web/public/owlcarousel/assets/owl.theme.default.min.css'/>" rel="stylesheet" type="text/css">
        ...
        <div class="head-first">
            <div class="container">
                ...
                <div class="box-social hidden-xs">
                    <ul class="ul-non ul-social">
                        <li class=""><a href="https://www.facebook.com/beautyshop" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        <li class="hidden-sm"><a href="https://www.instagram.com/beautyshop" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        <li class="hidden-sm"><a href="https://www.pinterest.com/beautyshop" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
                        <li class="hidden-sm"><a href="https://plus.google.com/beautyshop" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                    </ul>
                    <div class="box-pdseen" style="display: inline-block;">
                        <a style="cursor: pointer; color: #999;" id="lichsu">
                            <i class="fa fa-chevron-down"></i>
                            Sản phẩm bạn đã xem
                        </a>
                        <div class="box-after" id="load-seen" style="display: none; visibility: hidden;">
                            <div class="slider-productseen ul-pdseen ">
                                                                        <div class="" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 98px; display: inline-block; margin: 0px;">
                                            <div class="" style="width: 94.583px; margin-right: 0px;">
                                                <div class="item">
                                                    <a href="?page=product&id=135" title="Dưỡng Mi Eveline Cosmetics Lash Therapy">
                                                        <img src="images/products/20-08-2020/a1-31012019112847.jpg" alt="" class="img-reponsive">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="" style="width: 94.583px; margin-right: 0px;">
                                                <div class="item">
                                                    <a href="?page=product&id=70" title="Phấn Má + Bắt Sáng Sivanna Colors Glower Cheek">
                                                        <img src="images/products/21-07-2020/13243565-10102019100627.jpg" alt="" class="img-reponsive">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="" style="width: 94.583px; margin-right: 0px;">
                                                <div class="item">
                                                    <a href="?page=product&id=114" title="Mặt Nạ Giấy Foodaholic Essential Mask">
                                                        <img src="images/products/20-08-2020/avatar-sp-web11-recovered-recovered-recovered-22052020110145.jpg" alt="" class="img-reponsive">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="" style="width: 94.583px; margin-right: 0px;">
                                                <div class="item">
                                                    <a href="?page=product&id=118" title="Mặt Nạ Giấy LOreal Paris">
                                                        <img src="images/products/20-08-2020/123456780-22052020030607.jpg" alt="" class="img-reponsive">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="box-hotline">
                <ul class="ul-non ul-hotline">
                    <li>
                        <a href="tel:0989999111" class="just-hl"><span style="font-weight: bold;">Hotline:</span> <!-- 0989999111 -->
                            0989 999 111                        </a>
                    </li>
                    <li class="hidden-xs">
                        <a href="tel:19009198" class="just-hl">
                            <span>Tổng đài tư vấn:</span> 19009198                        </a></li>
                        <li class="hidden-xs">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-12">
                                <div class="box-logo">
                                    <a href="./">
                                        <img src="<c:url value='/template/images/products/24-07-2020/logo.png'/>" alt="" class="img-reponsive">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 order-lg-first col-md-6">
                                <div class="box-Sform">
                                    <form class="form-inline" method="post" action="?page=search">
                                        <input type="text" class="form-control my-form" id="inlineFormInputName2" placeholder="Tìm kiếm..." value="" autocomplete="off" onfocus="" onfocusout="" onkeydown="" name="search">
                                        <select class="custom-select my-form" id="inlineFormCustomSelectPref" name="option">
                                            <option selected value="0">Sản phẩm</option>
                                            <option value="1" hidden>Tin tức</option>
                                        </select>
                                        <button type="submit" class="btn btn-search" onclick="" id="buttonFormInputName2"><i class="fa fa-search" aria-hidden="true"></i></button>
                                    </form>
                                    <script type="text/javascript">
                                        $("#buttonFormInputName2").click(function(){
                                            check = $('#inlineFormInputName2').val();
                                            if (check=='') {
                                                $('#buttonFormInputName2').attr('type','button');
                                ...
                                <div class="box-menu">
                                    ...
                                    <ul class="ul-non ul-menu show" id="menu">
                                        ...
                                        <li class="li-parent-first hidden-xs hidden-sm">
                                            ...
                                            <ul class="ul-non ul-menu-lagi" id="ul-megaloger">
                                                ...
                                                <li>
                                                    <a href="?page=infor&select=introduce" class="">
                                                    ...
                                                    <ul class="ul-non ul-mega">
                                                        <li><a href="?page=infor&select=introduce">Giới thiệu Beautygarden</a></li>
                                        ...
                                        <!-- sádgfdas -->
                                        <li class="li-parent">
                                            <a href="?page=category&id=1" class="a-parent">
                                                Trang Điểm
                                        ...
                                        <li class="li-parent">
                                            <a href="?page=category&id=2" class="a-parent">
                                                Chăm Sóc Da
                                                <i class="fa fa-angle-down hidden-xs hidden-sm" aria-hidden="true"></i>
                                                <i class="fa fa-angle-right hidden-md" aria-hidden="true"></i>
                                            </a>
                                        ...
                                        <li class="li-parent">
                                            <a href="?page=category&id=3" class="a-parent">
                                                Chăm Sóc Tóc
                                                <i class="fa fa-angle-down hidden-xs hidden-sm" aria-hidden="true"></i>
                                                <i class="fa fa-angle-right hidden-md" aria-hidden="true"></i>
                                            </a>
                                        ...
                                        <li class="li-parent">
                                            <a href="?page=category&id=4" class="a-parent">
                                                Phụ Kiện
                                                <i class="fa fa-angle-down hidden-xs hidden-sm" aria-hidden="true"></i>
                                                <i class="fa fa-angle-right hidden-md" aria-hidden="true"></i>
                                            </a>
                                        ...
                                        <li class="li-parent">
                                            <a href="?page=category&id=5" class="a-parent">
                                                Nước Hoa
                                                <i class="fa fa-angle-down hidden-xs hidden-sm" aria-hidden="true"></i>
                                                <i class="fa fa-angle-right hidden-md" aria-hidden="true"></i>
                                            </a>
                                        ...
                                        <li class="li-parent">
                                            <a href="?page=category&id=6" class="a-parent">
                                                Chăm Sóc Toàn Thân
                                                <i class="fa fa-angle-down hidden-xs hidden-sm" aria-hidden="true"></i>
                                                <i class="fa fa-angle-right hidden-md" aria-hidden="true"></i>
                                            </a>
                                        ...
                                        <li class="li-parent">
                                            <a href="?page=off" class="a-parent">
                                                Khuyến mãi
                                    ...
                                    <ul class="ul-non ul-right">
                                        <li>
                                            ...
                                            <div class="searcf-s">
                                                <form class="form-inline" method="post" action="?page=search">
                                                    <input type="text" class="form-control my-form" id="inlineFormInputName3" placeholder="Tìm kiếm..." autocomplete="off" onfocus="" onfocusout="unfos2()" name="search">
                                                    <button type="button" class="btn btn-search" onclick="" id="buttonFormInputName3"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                </form>
                                                <script type="text/javascript">
                                                    $("#buttonFormInputName3").click(function(){
                                                        check = $('#inlineFormInputName3').val();
                                                        if (check=='') {
                                                            $('#buttonFormInputName3').attr('type','button');
                                                            alert('Bạn vui lòng nhập từ khóa!');
                                                        }
                                                    });
                                                </script>
                                        ...
                                        <li>
                                            <a href="./?page=cart">
                                                <i class="fa fa-shopping-cart " id="result2">3</i>
                                            </a>
                                        </li>
                                    </ul>
