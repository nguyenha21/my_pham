...
<!-- Custom CSS -->
<link
	href="<c:url value='/template/admin/assets/libs/chartist/dist/chartist.min.css'/>"
	rel="stylesheet">
<link
	href="<c:url value='/template/admin/assets/extra-libs/c3/c3.min.css'/>"
	rel="stylesheet">
<link
	href="<c:url value='/template/admin/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css'/>"
	rel="stylesheet" />
<!-- Custom CSS -->
<link href="<c:url value='/template/admin/dist/css/style.min.css'/>"
	rel="stylesheet">
					...
					<div class="navbar-brand">
						<a href="index.html" class="logo"> <!-- Logo icon --> <b
							class="logo-icon"> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
								...
								src="<c:url value='/template/admin/assets/images/logo-light-icon.png'/>"
								alt="homepage" class="light-logo" />
						</b> <!--End Logo icon --> <!-- Logo text --> <span class="logo-text">
								<!-- dark Logo text --> <img
								src="<c:url value='/template/admin/assets/images/logo-text.png'/>"
								alt="homepage" class="dark-logo" /> <!-- Light Logo text --> <img
								src="<c:url value='/template/admin/assets/images/logo-light-text.png'/>"
								class="light-logo" alt="homepage" />
						</span>
						</a> <a class="sidebartoggler d-none d-md-block"
					...
					<ul class="navbar-nav float-right">
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false"> <i
								class="font-22 mdi mdi-email-outline"></i>
								...
								<ul class="list-style-none">
									<li>
										<div class="drop-title text-white bg-danger">
											<h4 class="mb-0 m-t-5">5 Thông báo mới</h4>
											<span class="font-light">Tin nhắn</span>
										</div>
									</li>
									<li>
						...
						<!-- Comment -->
						<!-- ============================================================== -->
						<li class="nav-item dropdown border-right"><a
							class="nav-link dropdown-toggle waves-effect waves-dark" href=""
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="mdi mdi-bell-outline font-22"></i> <span
								class="badge badge-pill badge-info noti">3</span>
						</a>
							<div
								class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
								...
								<ul class="list-style-none">
									<li>
										<div class="drop-title bg-primary text-white">
											<h4 class="mb-0 m-t-5">4 Thông báo mới</h4>
						...
						<!-- ============================================================== -->
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle waves-effect waves-dark pro-pic"
							href="" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <img
								src="<c:url value='/template/admin/assets/images/users/2.jpg'/>"
								alt="user" class="rounded-circle" width="40"> <span
								class="m-l-5 font-medium d-none d-sm-inline-block">Nguyễn
									Hà <i class="mdi mdi-chevron-down"></i>
							</span>
						</a>
							<div
								...
								<div
									...
									<div class="m-l-10">
										<h4 class="mb-0">Nguyễn Hà</h4>
										<p class=" mb-0">jon@gmail.com</p>
									</div>
								</div>
								<a class="dropdown-item" href="javascript:void(0)"> <i
									class="ti-user m-r-5 m-l-5"></i> Thông tin tài khoản
								</a> <a class="dropdown-item" href="javascript:void(0)"> <i
									class="ti-wallet m-r-5 m-l-5"></i> Số dư
								</a> <a class="dropdown-item" href="javascript:void(0)"> <i
									class="ti-email m-r-5 m-l-5"></i> Hộp thư đến
								</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="javascript:void(0)"> <i
									class="ti-settings m-r-5 m-l-5"></i> Thiết lập tài khoản
								</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="javascript:void(0)"> <i
									class="fa fa-power-off m-r-5 m-l-5"></i> Đăng xuất
								</a>
								<div class="dropdown-divider"></div>
								<div class="p-l-30 p-10">
									<a href="javascript:void(0)"
										class="btn btn-sm btn-success btn-rounded">Xem hồ sơ</a>
								</div>
							</div></li>
						<!-- ============================================================== -->
						<!-- User profile and search -->
			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item"><a id="bang_dieu_khien"
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="mdi mdi-av-timer"></i> <span class="hide-menu">Bảng
									điều khiển </span>
						...
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="mdi mdi-tune"></i> <span class="hide-menu">Danh
									mục sản phẩm </span>
						</a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a id="all_product"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-view-quilt"></i> <span class="hide-menu">
											Tất cả sản phẩm </span>
								</a></li>
								<li class="sidebar-item"><a id="trang_diem"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-view-quilt"></i> <span class="hide-menu">
											Trang điểm </span>
								</a></li>
								<li class="sidebar-item"><a id="chamsocda"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-view-parallel"></i> <span class="hide-menu">
											Chăm sóc da </span>
								</a></li>
								<li class="sidebar-item"><a id="chamsoctoc"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-view-day"></i> <span class="hide-menu">
											Chăm sóc tóc </span>
								</a></li>
								<li class="sidebar-item"><a id="phukien"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-view-array"></i> <span class="hide-menu">
											Phụ kiện </span>
								</a></li>
								<li class="sidebar-item"><a id="nuochoa"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-view-module"></i> <span class="hide-menu">
											Nước hoa </span>
								</a></li>
							</ul></li>
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="mdi mdi-crop-square"></i> <span class="hide-menu">Thông
									tin tài khoản </span>
						</a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a id="khachhang"
									href="javascript:void(0)"
									class="sidebar-link"> <i class="mdi mdi-format-align-left"></i>
										<span class="hide-menu"> Khách hàng </span>
								</a></li>
								<li class="sidebar-item"><a id="khachvanglai"
									href="javascript:void(0)"
									class="sidebar-link"> <i class="mdi mdi-format-align-right"></i>
										<span class="hide-menu"> Khách hàng vãng lai </span>
								</a></li>
								<li class="sidebar-item"><a id="nhanvien"
									href="javascript:void(0)" class="sidebar-link">
										<i class="mdi mdi-format-float-left"></i> <span
										class="hide-menu"> Nhân viên </span>
								</a></li>
								<li>
							</ul></li>
						...
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="mdi mdi-inbox"></i> <span class="hide-menu">Giao
									diện </span>
						</a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="javascript:void(0)" id="logo"
									class="sidebar-link"> <i class="mdi mdi-email"></i> <span
										class="hide-menu"> Logo </span>
								</a></li>
								<li class="sidebar-item"><a href="javascript:void(0)" id="slideshow"
									class="sidebar-link"> <i class="mdi mdi-email-alert"></i> <span
										class="hide-menu"> Slide show </span>
								</a></li>
						...
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="ti-bookmark"></i> <span class="hide-menu">Kho </span>
						</a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="javascript:void(0)" id="moi"
									class="sidebar-link"> <i class="mdi mdi-book-multiple"></i>
										<span class="hide-menu"> Sản phẩm mới </span>
								</a></li>
								<li class="sidebar-item"><a href="javascript:void(0)" id="banchay"
									class="sidebar-link"> <i class="mdi mdi-book-plus"></i> <span
										class="hide-menu"> Sản phẩm bán chạy </span>
								</a></li>
								<li class="sidebar-item"><a href="javascript:void(0)" id="het"
									class="sidebar-link"> <i class="mdi mdi-book-plus"></i> <span
										class="hide-menu"> Sản phẩm hết </span>
								</a></li>
						...
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="mdi mdi-gradient"></i> <span class="hide-menu">Đơn
									hàng </span>
						</a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="javascript:void(0)" id="chuaxuly"
									class="sidebar-link"> <i class="ti-comment"></i> <span
										class="hide-menu"> Đơn hàng chưa xử lý </span>
								</a></li>
								<li class="sidebar-item"><a href="javascript:void(0)" id="dangvanchuyen"
									class="sidebar-link"> <i class="mdi mdi-calendar-range"></i>
										<span class="hide-menu"> Đơn hàng đang vận chuyện </span>
								</a></li>
								<li class="sidebar-item"><a href="javascript:void(0)" id="dahuy"
									class="sidebar-link"> <i class="ti-menu-alt"></i> <span
										class="hide-menu"> Đơn hàng đã hủy </span>
								</a></li>
							</ul></li>
						...
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								class="far fa-list-alt"></i> <span class="hide-menu">Hệ
									thống cửa hàng </span>
						</a></li>
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"> <i
								...
								class="hide-menu">Thông tin website</span>
						</a></li>
						...
						<li class="sidebar-item"><a
							...
							href="authentication-login1.html" aria-expanded="false"> <i
								class="mdi mdi-directions"></i> <span class="hide-menu">Log
									Out</span>
						</a></li>
					</ul>
				</nav>
...
$(document).ready(function(){
    $("#bang_dieu_khien").click(function(){
        $.ajax({
            type: "POST",
				...
				<ul class="nav customizer-tab" role="tablist">
					<li class="nav-item"><a class="nav-link active"
						...
						role="tab" aria-controls="pills-home" aria-selected="true"> <i
							class="mdi mdi-wrench font-20"></i>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						id="pills-profile-tab" data-toggle="pill" href="#chat" role="tab"
						aria-controls="chat" aria-selected="false"> <i
							class="mdi mdi-message-reply font-20"></i>
					</a></li>
					<li class="nav-item"><a class="nav-link"
					...
					<div class="tab-pane fade show active" id="pills-home"
						...
						<div class="p-15 border-bottom">
							...
							<div class="custom-control custom-checkbox m-t-10">
								<input type="checkbox" class="custom-control-input"
									name="theme-view" id="theme-view"> <label
									class="custom-control-label" for="theme-view">Dark
									Theme</label>
							</div>
							<div class="custom-control custom-checkbox m-t-10">
								<input type="checkbox"
									class="custom-control-input sidebartoggler"
						...
						<div class="p-15 border-bottom">
							...
							<ul class="theme-color">
								...
								<li class="theme-item"><a href="javascript:void(0)"
									class="theme-link" data-logobg="skin2"></a></li>
								<li class="theme-item"><a href="javascript:void(0)"
									class="theme-link" data-logobg="skin3"></a></li>
								<li class="theme-item"><a href="javascript:void(0)"
									class="theme-link" data-logobg="skin4"></a></li>
								<li class="theme-item"><a href="javascript:void(0)"
									class="theme-link" data-logobg="skin5"></a></li>
								<li class="theme-item"><a href="javascript:void(0)"
									class="theme-link" data-logobg="skin6"></a></li>
							</ul>
							<!-- Logo BG -->
						</div>
						<div class="p-15 border-bottom">
							...
							<li>
								<div class="message-center chat-scroll">
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_1' data-user-id='1'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_2' data-user-id='2'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_3' data-user-id='3'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_4' data-user-id='4'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_5' data-user-id='5'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_6' data-user-id='6'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_7' data-user-id='7'> <span class="user-img">
									...
									<!-- Message -->
									<a href="javascript:void(0)" class="message-item"
										id='chat_user_8' data-user-id='8'> <span class="user-img">
					...
					<div class="tab-pane fade p-15" id="pills-contact" role="tabpanel"
						...
						<div class="steamline">
							...
							<div class="sl-item">
								...
								<div class="sl-right">
									<div>
										<a href="javascript:void(0)">Stephen</a> <span class="sl-date">5
											minutes ago</span>
									</div>
