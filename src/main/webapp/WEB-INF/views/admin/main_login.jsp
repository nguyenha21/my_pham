        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<c:url value='/template/admin/assets/images/big/auth-bg.jpg'/>) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" action="admin" method="POST">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><i class="ti-user"></i></span>
                                    </div>
                                    <input type="text" name="username" class="form-control form-control-lg" placeholder="Tên tài khoản" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon2"><i class="ti-pencil"></i></span>
                                    </div>
                                    <input type="text" name="password" class="form-control form-control-lg" placeholder="Mật khẩu" aria-label="Password" aria-describedby="basic-addon1">
                                </div>
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Bạn chưa có tài khoản? <a href="authentication-register1.html" class="text-info m-l-5"><b>Đăng ký</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
