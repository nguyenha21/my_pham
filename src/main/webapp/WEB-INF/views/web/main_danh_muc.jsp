                            ...
                            <div class="my-content">
                                ...
                                <div class="head-box">
                                    ...
                                    <div class="select hidden-sm hidden-xs">
                                     <a style="border-left:1px solid #d0cccc" href="?page=category&id=<?php echo $ma_dm ?>&sort=0" class="<?php if($sort==0){echo 'active';} ?>">Mới về</a>
                                     <a href="?page=category&id=<?php echo $ma_dm ?>&sort=1" class="<?php if($sort==1){echo 'active';} ?>">Giá</a>
                                     <a href="?page=category&id=<?php echo $ma_dm ?>&sort=2" class="<?php if($sort==2){echo 'active';} ?>">Mua nhiều</a>
                                 </div>
                                 <div class="clr"></div>
                             </div>
                             ...
                             <div class="filter mar-bot-10 text-right hidden-md">
                                <div class="select2 ">
                                    <a style="border-left:1px solid #d0cccc" href="?page=category&id=1&sort=0" class="<?php if($sort==0){echo 'active';} ?>">Mới về</a>
                                    <a href="?page=category&id=<?php echo $ma_dm ?>&sort=1" class="<?php if($sort==1){echo 'active';} ?>">Giá</a>
                                    <a href="?page=category&id=<?php echo $ma_dm ?>&sort=2" class="<?php if($sort==2){echo 'active';} ?>">Mua nhiều</a>
                                </div>
                            </div>
                                    ...
                                    <?php while ($resultProductDm = mysqli_fetch_assoc($queryProductDm)) {
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 pan-right mar-bot-10">
                                            <div class="pd-box ">
                                                <div class="box-images">
                                                    ...
                                                    <button type="button" onclick="load_cart(<?php echo $resultProductDm['ma_sp'] ?>)" class="btn-addlike "><i class="fa fa-cart-plus"></i></button>
                                        ...
                                        <!-- kết thúc -->
                                         <?php 
                                            ...
                                            $gia_ban = $resultProductDm['gia_ban'];
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 pan-right mar-bot-10">
                                            <div class="pd-box ">
                                                <div class="box-images">
                                                    ...
                                                    <button type="button" onclick="load_cart(<?php echo $resultProductDm['ma_sp'] ?>)" class="btn-addlike "><i class="fa fa-cart-plus"></i></button>
                                                    <div class="sale-off"><?php echo $resultKM['gia_tri_km']; ?>%<br>OFF</div>
                                                </div>
                                                <div class="box-content">
                                                    <h3>
                                                        <a href="?page=product&id=<?php echo $resultProductDm['ma_sp'] ?>" title=""><?php echo $resultProductDm['ten_sp']; ?> </a>
                                                    ...
                                                    <div>
                                                        <span class="price-drop"><?php echo number_format($gia_sau, 0, ',', ','); ?>₫</span>
                                                        <span class="price "><?php echo number_format($resultProductDm['gia_thi_truong'], 0, ',', ','); ?>₫</span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="pagination">
                                    <div class="page">
                                        ...
                                        if ($current_page > 3) {
                                            $first_page = 1;
                                            ?>
                                            <a class="page-item" href="?page=category&id=<?php echo $ma_dm ?>&pagination=<?= $first_page ?>&sort=<?php echo $sort ?>"><i class="fa fa-fast-backward"></i></a>
                                            <?php
                                        }
                                        if ($current_page > 1) {
                                            $prev_page = $current_page - 1;
                                            ?>
                                            <a class="page-item" href="?page=category&id=<?php echo $ma_dm ?>&pagination=<?= $prev_page ?>&sort=<?php echo $sort ?>"><i class="fa fa-backward"></i></a>
                                        <?php }
                                        ?>
                                        <?php for ($num = 1; $num <= $totalPages; $num++) { ?>
                                            <?php if ($num != $current_page) { ?>
                                                <?php if ($num > $current_page - 3 && $num < $current_page + 3) { ?>
                                                    <a class="page-item" href="?page=category&id=<?php echo $ma_dm ?>&pagination=<?= $num ?>&sort=<?php echo $sort ?>"><?= $num ?></a>
                                                <?php } ?>
                                            <?php } else { ?>
                                        ...
                                        if ($current_page < $totalPages - 1) {
                                            ...
                                            ?>
                                            <a class="page-item" href="?page=category&id=<?php echo $ma_dm ?>&pagination=<?= $next_page ?>&sort=<?php echo $sort ?>"><i class="fa fa-forward"></i></a>
                                            <?php
                                        }
                                        if ($current_page < $totalPages - 3) {
                                            $end_page = $totalPages;
                                            ?>
                                            <a class="page-item" href="?page=category&id=<?php echo $ma_dm ?>&pagination=<?= $end_page ?>&sort=<?php echo $sort ?>"><i class="fa fa-fast-forward"></i></a>
                                            <?php
                                        }
                                        ?>
                                    </div>
                               ...
                               <!--kết thúc  -->
                                ...
                                <div class="box-shas">
                                    ...
                                    <div class="content-shas">
                                       ...
                                       <span><?php echo number_format($gia_sau, 0, ',', ','); ?>₫</span>
                                   </div>
                                   <div class="clr"></div>
                               </div>       
                               <!--kết thúc  -->
